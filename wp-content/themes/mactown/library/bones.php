...
function bones_scripts_and_styles() {
  ...
  if (!is_admin()) {
    ...
    // FitText JS
    wp_register_script( 'fittext', get_stylesheet_directory_uri(). '/library/js/libs/jquery.fittext.js', array('jquery'), '1.0.0', false );
...
// Function to add css to admin section for hiding certain elements
function hide_dashboard_elements() {
  echo "<link rel='stylesheet' media='screen' type='text/css' href='" . get_template_directory_uri() .  "/library/css/admin.css'>";
}
add_action( 'admin_head', 'hide_dashboard_elements' );
...
function bones_main_nav() {
    ...
    wp_nav_menu(array(
    	...
    	'container_class' => 'collapse navbar-collapse navbar-ex1-collapse', 	// class of container (should you choose to use it)
...
return '...  <a class="excerpt-read-more" href="'. get_permalink($post->ID) . '" title="'. __( 'Read', 'bonestheme' ) . get_the_title($post->ID).'">'. __( 'Continue reading', 'bonestheme' ) .'</a>';
}
