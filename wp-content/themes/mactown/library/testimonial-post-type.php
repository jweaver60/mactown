...
function create_testimonial_post_type() { 
	...
	register_post_type( 'testimonial', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		...
		array( 'labels' => array(
			...
			'description' => __( 'Custom post type for Testimonials', 'bonestheme' ), /* Custom Type Description */
			'public' => true,
			...
			'menu_icon' => get_stylesheet_directory_uri() . '/library/images/receipt-text.png', /* the icon for the custom post type menu */
