...
function create_partners_post_type() { 
	...
	register_post_type( 'partner', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		...
		array( 'labels' => array(
			...
			'description' => __( 'Custom post type for Partners', 'bonestheme' ), /* Custom Type Description */
			'public' => true,
			...
			'menu_icon' => get_stylesheet_directory_uri() . '/library/images/trophy.png', /* the icon for the custom post type menu */
